 ...
 */
UCLASS(ClassGroup = (UI), meta = (BlueprintSpawnableComponent, Blueprintable, DisplayName = "My Player UI"))
...
public:
    ...
    void SetOwningCharacter(AMyCharacter *InCharacter) { OwningCharacter = InCharacter; }
