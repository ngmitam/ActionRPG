...
UMyAnimNotify_ComboWindowEnd::UMyAnimNotify_ComboWindowEnd()
{
}

void UMyAnimNotify_ComboWindowEnd::Notify(USkeletalMeshComponent *MeshComp, UAnimSequenceBase *Animation)
{
    if (!MeshComp)
    {
        return;
    ...
    // Get the current attack ability and end combo window
